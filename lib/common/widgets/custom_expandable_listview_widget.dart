...
class CustomExpandableListView extends StatefulWidget {
  ...
  CustomExpandableListView({Key key,
  ...
  @override
  _CustomExpandableListViewState createState() => _CustomExpandableListViewState();
}

class _CustomExpandableListViewState extends State<CustomExpandableListView> {
  bool _isExpanded;
